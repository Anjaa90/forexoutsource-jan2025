...
<section class="page-header-wrapper">
        <div class="container">
            <h1 class="text-center white-color text-capitalize">Privacy Policy</h1>
            ...
            <div class="col-12 mb-7">
                <div class="service-details">
                    <div class="service-details-list text-dark">
                        <h2 class="heading-one">Privacy Policy for ForexOutsource
                        </h2>
                        <p>At ForexOutsource, accessible from http://forexoutsource.com/, one of our main priorities is the privacy of our visitors. This Privacy Policy
                            document contains types of information that is collected and recorded by ForexOutsource and how we use it.</p>
                        ...
                        <p>This Privacy Policy applies only to our online activities and is valid for visitors 
                            to our website with regards to the information that they shared and/or collected in
                             ForexOutsource. This policy is not applicable to any information collected offline or 
                             via channels other than this website.</p><br>
...
<p>When you register for an Account, we may ask for your contact information, including items such as name, company name, address, email address, and telephone number.</p>                        
                        ...
                        <ul class="list-bullets">
                            <li><i class="fas fa-long-arrow-alt-right"></i>Provide, operate, and maintain our website
                            </li>
                            <li><i class="fas fa-long-arrow-alt-right"></i>Improve, personalize, and expand our website
                            </li>
                            <li><i class="fas fa-long-arrow-alt-right"></i>Understand and analyze how you use our website
                            </li>
                            <li><i class="fas fa-long-arrow-alt-right"></i>Develop new products, services, features, and functionality
                            </li>
                            <li><i class="fas fa-long-arrow-alt-right"></i>Communicate with you, either directly or through one of our partners, including for customer service, to provide you with updates and other information relating to the website, and for marketing and promotional purposes
                            </li>
                            <li><i class="fas fa-long-arrow-alt-right"></i>Send you emails
                            </li>
                            <li><i class="fas fa-long-arrow-alt-right"></i>Find and prevent fraud
                            </li>
                        ...
                        <p>We may update our Privacy Policy from time to time. Thus, we advise you to review this page periodically for any changes. We will notify you of any changes by posting the new Privacy Policy on this page.
